...
## 📊 Project Overview
The dashboard helps answer critical sales-related questions:
- How do opportunities progress through each stage of the funnel?
- Which channel — direct or partner — delivers higher conversion success?
...
- Leads: 100% (203)
- Finalized Deals: 5.42%
- Direct conversion success: 0.27
- Partner conversion success: 0.18
  
 **Sales Cycle Duration**
- Direct channel: ~400 units
- Partner channel: ~450 units
  
 **Revenue Distribution (2025)**
- Direct channel: ~149M
- Partner channel (combined): ~92M
- Top partners: Soltaron (13M), Joblancon (11M), Qualisaclace (8M)

 **Regional & Segment Impact**
- Stronger performance in East & Central regions
- Large & Strategic segments outperform Small & Medium

**Seasonal Trends**
- Peak revenue in January: 47M
- Sharp decline by May: 10M
- Near-flatline from August–December

---

## 🛠️ Tools Used
- Power BI Desktop – Dashboard design, modeling, and visualization
- Excel / CSV – Data ingestion and preprocessing
- DAX – Custom measures for aggregation, filtering, and time-based trends

---

## 🎯 Skills Applied
- Data Modeling – Structuring datasets for efficient analysis and reporting
- Data Visualization – Designing clear, impactful charts and dashboards
- Business Analysis – Translating sales and partner performance into actionable insights
- Trend Analysis – Identifying seasonal patterns and opportunity lifecycles
- Performance Benchmarking – Comparing direct vs. partner channels and segment contributions

---

## 🔧 Data Preparation Steps
- Cleaned & standardized partner names, regions, and segments
- Normalized funnel stages for consistency
- Built time dimension for full 2025 calendar year
- Modeled relationships across opportunities, revenue, partners, and segments
- Created DAX measures for:
  ...
  .Weighted partner revenue

  .Regional & segment comparisons

  .Monthly revenue & opportunity trends

  ---

## 📊 Dashboard Insights
- Funnel Efficiency – Only 5.42% of leads reach finalization, with direct channels converting slightly better than partners.
- Partner Impact – Direct channel dominates (~149M), while top partners like Soltaron and Joblancon contribute significantly but remain far behind.
